...
逻辑图（Linux Bridge + VLAN tagged 示例）:
...
- veth1-br 打上 VLAN 10 标签，veth2-br 打上 VLAN 20 标签
...
print_section "配置 VLAN（桥接端口为 tagged 模式，允许对应 VLAN）"
# 不设置 pvid，桥接端口为 trunk，允许对应 VLAN 的 tagged 流量
